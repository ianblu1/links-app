...
def login():
    if request.method == "POST" and "email" in request.form:
        ...
        if flask_bcrypt.check_password_hash(user.password.encode('ascii','ignore'),request.form["password"]):
            print "password hashed correctly"
        
        if user and flask_bcrypt.check_password_hash(user.password.encode('ascii','ignore'),request.form["password"]) and user.is_active():
